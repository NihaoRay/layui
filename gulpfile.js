	...
	task = {
		...
		minjs: function(ver) {
				...
				var mod = argv.mod ? function() {
					...
					src = [
						'./src/**/*' + mod + '.js', '!./src/**/mobile/*.js', '!./src/lay/**/mobile.js', '!./src/lay/all.js', '!./src/lay/all-mobile.js'
					],
		...
		alljs: function(ver) {
				...
				var src = [
						'./src/**/{layui,all,' + mods + '}.js', '!./src/**/mobile/*.js'
					],
					dir = ver ? release : 'dist';
		...
		mobile: function(ver) {
				...
				var mods = 'layer-mobile,zepto,upload-mobile',
					src = [
						'./src/lay/all-mobile.js', './src/lay/modules/laytpl.js', './src/**/mobile/{' + mods + '}.js'
					],
					dir = ver ? release : 'dist';
